<?php
/*
Plugin Name: Users and Roles: Get All Roles
...
function get_roles_add_toplevel_menu() {
	...
	add_menu_page(
		esc_html__('Users and Roles: Get All Roles', 'myplugin'),
		esc_html__('Get All Roles', 'myplugin'),
		'manage_options',
		'get_roles',
...
function get_roles_display_settings_page() {
	...
	<div class="wrap">
		...
		<p><?php esc_html_e( 'This plugin demo shows all user roles and capabilities for the site.', 'myplugin' ); ?></p>
