...
function myplugin_callback_section_login() {
	...
	echo '<p>'. esc_html__('Esta configuración habilita la configuración de la entrada a wordpress.', 'myplugin') .'</p>';
...
function myplugin_options_radio() {
	...
	return array(
		...
		'enable'  => esc_html__('Habilita estilos', 'myplugin'),
		'disable' => esc_html__('Deshabilita estilos', 'myplugin')
