<?php
/*
Plugin Name: Add Document Type Styles New Final
Plugin URI: https://github.com/edgargregori/wpdev
Description: Detects URLs in your posts and pages and displays nice document type icons next to them. Includes support for: PDF, DOC, MP3, PNG and ZIP.
Version: 1.2
Author: Edgar Gregori
Author URI: https://github.com/edgargregori
Text Domain: add_doctype_styles_new_final
...
function set_supportedtypes_options() {
	add_option("doctype_styles_new_supportedtypes","pdf,doc,mp3,zip,png");
}
